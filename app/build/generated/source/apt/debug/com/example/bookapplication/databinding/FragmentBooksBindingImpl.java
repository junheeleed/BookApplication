...
public class FragmentBooksBindingImpl extends FragmentBooksBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.search_type_spinner, 1);
        sViewsWithIds.put(R.id.searchView, 2);
        sViewsWithIds.put(R.id.recyclerview, 3);
        sViewsWithIds.put(R.id.book_progressbar, 4);
    }
    // views
    @NonNull
    ...
    public FragmentBooksBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private FragmentBooksBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
